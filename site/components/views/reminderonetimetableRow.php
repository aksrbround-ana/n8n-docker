...
<tr id="onetime-reminder-row-<?= $reminder['id'] ?>" class="<?= implode(' ', $class) ?>" data-item-id="<?= $reminder['id'] ?>">
    ...
    <td class="onetime-reminder-activity p-6 pt-0" style="white-space: nowrap;">
