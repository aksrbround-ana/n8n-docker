            ...
            <tr data-tax-id="<?= $reminder['reminder_id'] ?>" class="tax-row border-b hover:bg-secondary/30 transition-colors cursor-pointer">
                <td class="p-4 align-middle">
                    <div class="flex items-center gap-2">
                        <div>
                            <p class="font-medium text-sm truncate max-w-[200px]"><?= $user->lang == DictionaryService::LANG_RUSSIAN ? $reminder['type_ru'] : $reminder['type_rs'] ?></p>
                        </div>
                    </div>
                </td>
                <td class="p-4 align-middle text-sm"><?= $user->lang == DictionaryService::LANG_RUSSIAN ? $reminder['text_ru'] : $reminder['text_rs'] ?></td>
                <td class="p-4 align-middle text-sm"><?= $reminder['deadline_day'] ?></td>
                <td class="p-4 align-middle">
                    <input class="reminder-activity" type="checkbox" <?= $checked ?> data-reminder-type="regular" data-rm-id="<?= $reminder['reminder_id'] ?>" data-sc-id="<?= $reminder['schedule_id'] ?>" data-co-id="<?= $reminder['company_id'] ?>" data-type="rr">
                </td>
                <td class="p-4 align-middle text-sm"><?= $statusLastNotified ?></td>
                <td class="p-4 align-middle">
                    <button data-rm-id="<?= $reminder['reminder_id'] ?>" data-reminder-type="regular" data-sc-id="<?= $reminder['schedule_id'] ?>" data-co-id="<?= $reminder['company_id'] ?>" data-type="rs" class="stop-reminder-btn<?= $buttonVisibility['stopBtn'] ?> inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border border-input bg-background hover:bg-accent hover:text-accent-foreground h-10 px-4 py-2">
                        <?= SvgService::svg('stop') ?>
...
<div class="accordeon-item mb-4 flex items-center justify-between lg:grid-cols-2">
    <h3 class="font-semibold text-left cursor-pointer" style="padding-left: 20px; color:gray;"><?= DictionaryService::getWord('yearlyReminders', $user->lang) ?></h3>
    <?= SvgService::svg('arrow-down') ?>
</div>
<table class="accordeon-table w-full caption-bottom text-sm hidden">
    <thead class="border-b bg-secondary/50">
    ...
    <tbody class="">
        <?php
        foreach ($yearlyReminders as $reminder) {
            $checked = $reminder['schedule_id'] ? ' checked' : '';
            $statusLastNotified = '';
            switch ($reminder['last_notified_type']) {
                case 'first':
        ...
        ?>
            <tr data-tax-id="<?= $reminder['reminder_id'] ?>" class="tax-row border-b hover:bg-secondary/30 transition-colors cursor-pointer">
                ...
                <td class="p-4 align-middle text-sm"><?= $user->lang == DictionaryService::LANG_RUSSIAN ? $reminder['text_ru'] : $reminder['text_rs'] ?></td>
                <td class="p-4 align-middle text-sm"><?= $reminder['deadline_day'] . '/' . $reminder['deadline_month'] ?></td>
                <td class="p-4 align-middle">
                    <input class="reminder-activity" type="checkbox" <?= $checked ?> data-reminder-type="yearly" data-rm-id="<?= $reminder['reminder_id'] ?>" data-sc-id="<?= $reminder['schedule_id'] ?>" data-co-id="<?= $reminder['company_id'] ?>" data-type="rr">
                </td>
                <td class="p-4 align-middle text-sm"><?= $statusLastNotified ?></td>
                <td class="p-4 align-middle">
                    <button data-rm-id="<?= $reminder['reminder_id'] ?>" data-reminder-type="yearly" data-sc-id="<?= $reminder['schedule_id'] ?>" data-co-id="<?= $reminder['company_id'] ?>" data-type="rs" class="stop-reminder-btn<?= $buttonVisibility['stopBtn'] ?> inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border border-input bg-background hover:bg-accent hover:text-accent-foreground h-10 px-4 py-2">
                        <?= SvgService::svg('stop') ?>
                        <?= DictionaryService::getWord('stop', $user->lang) ?>
                    </button>
                    <div class="stopped-reminder<?= $buttonVisibility['stoppedBtn'] ?> inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border border-input bg-background h-10 px-4 py-2"><?= DictionaryService::getWord('stopped', $user->lang) ?></div>
...
<div class="accordeon-item mb-4 flex items-center justify-between lg:grid-cols-2">
    <h3 class="font-semibold text-left cursor-pointer" style="padding-left: 20px; color:gray;"><?= DictionaryService::getWord('oneTimeReminders', $user->lang) ?></h3>
    <?= SvgService::svg('arrow-down') ?>
</div>
<table class="accordeon-table w-full caption-bottom text-sm hidden">
    <thead class="border-b bg-secondary/50">
    ...
    <tbody class="">
        <?php
        foreach ($onetimeReminders as $reminder) {
            $checked = $reminder['schedule_id'] ? ' checked' : '';
            $statusLastNotified = '';
            switch ($reminder['last_notified_type']) {
                case 'first':
        ...
        ?>
            <tr data-tax-id="<?= $reminder['reminder_id'] ?>" class="tax-row border-b hover:bg-secondary/30 transition-colors cursor-pointer">
                ...
                <td class="p-4 align-middle text-sm"><?= $user->lang == DictionaryService::LANG_RUSSIAN ? $reminder['text_ru'] : $reminder['text_rs'] ?></td>
                <td class="p-4 align-middle text-sm"><?= $reminder['deadline'] ?></td>
                <td class="p-4 align-middle">
                    <input class="reminder-activity" type="checkbox" <?= $checked ?> data-reminder-type="one-time" data-rm-id="<?= $reminder['reminder_id'] ?>" data-sc-id="<?= $reminder['schedule_id'] ?>" data-co-id="<?= $reminder['company_id'] ?>" data-type="rr">
                </td>
                <td class="p-4 align-middle text-sm"><?= $statusLastNotified ?></td>
                <td class="p-4 align-middle">
                    <button data-rm-id="<?= $reminder['reminder_id'] ?>" data-reminder-type="one-time" data-sc-id="<?= $reminder['schedule_id'] ?>" data-co-id="<?= $reminder['company_id'] ?>" data-type="rs" class="stop-reminder-btn<?= $buttonVisibility['stopBtn'] ?> inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border border-input bg-background hover:bg-accent hover:text-accent-foreground h-10 px-4 py-2">
                        <?= SvgService::svg('stop') ?>
                        <?= DictionaryService::getWord('stop', $user->lang) ?>
                    </button>
                    <div class="stopped-reminder<?= $buttonVisibility['stoppedBtn'] ?> inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border border-input bg-background h-10 px-4 py-2"><?= DictionaryService::getWord('stopped', $user->lang) ?></div>
        ...
        ?>
            <tr data-tax-id="<?= $reminder['reminder_id'] ?>" class="tax-row border-b hover:bg-secondary/30 transition-colors cursor-pointer">
                <td class="p-4 align-middle">
                    <div class="flex items-center gap-2">
                        <div>
                            <p class="font-medium text-sm truncate max-w-[200px]"><?= $user->lang == DictionaryService::LANG_RUSSIAN ? $reminder['topic_ru'] : $reminder['topic_rs'] ?></p>
                        </div>
                    </div>
                </td>
                <td class="p-4 align-middle text-sm"><?= $user->lang == DictionaryService::LANG_RUSSIAN ? $reminder['text_ru'] : $reminder['text_rs'] ?></td>
