...
(() => {
    ...
    var pe = Object.getOwnPropertyNames, G = Object.getOwnPropertySymbols, _e = Object.getPrototypeOf, V = Object.prototype.hasOwnProperty, be = Object.prototype.propertyIsEnumerable;
    var Q = (o, s, e) => s in o ? J(o, s, { enumerable: !0, configurable: !0, writable: !0, value: e }) : o[s] = e, q = (o, s) => {
        for (var e in s ||= {}) V.call(s, e) && Q(o, e, s[e]);
    ...
    var ge = (o, s, e, t) => {
        if (s && typeof s == "object" || typeof s == "function") for (let n of pe(s)) !V.call(o, n) && n !== e && J(o, n, { get: () => s[n], enumerable: !(t = de(s, n)) || t.enumerable });
        return o
    };
    var X = (o, s, e) => (e = o != null ? fe(_e(o)) : {}, ge(s || !o || !o.__esModule ? J(e, "default", { value: o, enumerable: !0 }) : e, o));
    var C = (o, s, e) => new Promise((t, n) => {
        var i = c => {
            try { a(e.next(c)) }
            catch (l) { n(l) }
        }, r = c => {
    ...
    var H = me((Re, F) => {
        "use strict";
        var y = typeof Reflect == "object" ? Reflect : null, Y = y && typeof y.apply == "function" ? y.apply : function (s, e, t) { return Function.prototype.apply.call(s, e, t) }, R;
        y && typeof y.ownKeys == "function" ? R = y.ownKeys : Object.getOwnPropertySymbols ? R = function (s) { return Object.getOwnPropertyNames(s).concat(Object.getOwnPropertySymbols(s)) }
            : R = function (s) { return Object.getOwnPropertyNames(s) };
        function ve(o) { console && console.warn && console.warn(o) }
        var $ = Number.isNaN || function (s) { return s !== s };
        ...
        var Z = 10;
        function k(o) { if (typeof o != "function") throw new TypeError('The "listener" argument must be of type Function. Received type ' + typeof o) }
        Object.defineProperty(u, "defaultMaxListeners", {
            enumerable: !0, get: function () { return Z }, set: function (o) {
        ...
        u.init = function () { (this._events === void 0 || this._events === Object.getPrototypeOf(this)._events) && (this._events = Object.create(null), this._eventsCount = 0), this._maxListeners = this._maxListeners || void 0 };
        ...
        function ee(o) { return o._maxListeners === void 0 ? u.defaultMaxListeners : o._maxListeners }
        u.prototype.getMaxListeners = function () { return ee(this) };
        u.prototype.emit = function (s) {
            ...
            else for (var l = c.length, b = re(c, l), t = 0;
                t < l;
                ++t)Y(b[t], this, e);
            return !0
        };
        function te(o, s, e, t) {
            var n, i, r;
            if (k(e), i = o._events, i === void 0 ? (i = o._events = Object.create(null), o._eventsCount = 0) : (i.newListener !== void 0 && (o.emit("newListener", s, e.listener ? e.listener : e), i = o._events), r = i[s]), r === void 0) r = i[s] = e, ++o._eventsCount;
        ...
        u.prototype.addListener = function (s, e) { return te(this, s, e, !1) };
        u.prototype.on = u.prototype.addListener;
        u.prototype.prependListener = function (s, e) { return te(this, s, e, !0) };
        function ye() { if (!this.fired) return this.target.removeListener(this.type, this.wrapFn), this.fired = !0, arguments.length === 0 ? this.listener.call(this.target) : this.listener.apply(this.target, arguments) }
        function ne(o, s, e) {
            var t = { fired: !1, wrapFn: void 0, target: o, type: s, listener: e }, n = ye.bind(t);
            return n.listener = e, t.wrapFn = n, n
        }
        u.prototype.once = function (s, e) { return k(e), this.on(s, ne(this, s, e)), this };
        u.prototype.prependOnceListener = function (s, e) { return k(e), this.prependListener(s, ne(this, s, e)), this };
        u.prototype.removeListener = function (s, e) {
            var t, n, i, r, a;
            if (k(e), n = this._events, n === void 0) return this;
            if (t = n[s], t === void 0) return this;
            if (t === e || t.listener === e) --this._eventsCount === 0 ? this._events = Object.create(null) : (delete n[s], n.removeListener && this.emit("removeListener", s, t.listener || e));
            else if (typeof t != "function") {
                for (i = -1, r = t.length - 1;
                    r >= 0;
                    r--)if (t[r] === e || t[r].listener === e) {
                        a = t[r].listener, i = r;
                        break
                    }
                if (i < 0) return this;
        ...
        u.prototype.removeAllListeners = function (s) {
            ...
            if (arguments.length === 0) {
                ...
                for (n = 0;
                    n < i.length;
                    ++n)r = i[n], r !== "removeListener" && this.removeAllListeners(r);
                return this.removeAllListeners("removeListener"), this._events = Object.create(null), this._eventsCount = 0, this
            }
            if (e = t[s], typeof e == "function") this.removeListener(s, e);
            else if (e !== void 0) for (n = e.length - 1;
                n >= 0;
                n--)this.removeListener(s, e[n]);
            return this
        };
        function se(o, s, e) {
            var t = o._events;
        ...
        u.prototype.listeners = function (s) { return se(this, s, !0) };
        u.prototype.rawListeners = function (s) { return se(this, s, !1) };
        u.listenerCount = function (o, s) { return typeof o.listenerCount == "function" ? o.listenerCount(s) : ie.call(o, s) };
        ...
        u.prototype.eventNames = function () { return this._eventsCount > 0 ? R(this._events) : [] };
        function re(o, s) {
            for (var e = new Array(s), t = 0;
                t < s;
                ++t)e[t] = o[t];
            return e
        }
        ...
        function xe(o) {
            for (var s = new Array(o.length), e = 0;
                e < s.length;
                ++e)s[e] = o[e].listener || o[e];
            return s
        }
        function Te(o, s) {
            return new Promise(function (e, t) {
                ...
                oe(o, s, i, { once: !0 }), s !== "error" && Ce(o, n, { once: !0 })
            })
        }
        function Ce(o, s, e) { typeof o.on == "function" && oe(o, "error", s, e) }
        function oe(o, s, e, t) {
            if (typeof o.on == "function") t.once ? o.once(s, e) : o.on(s, e);
            else if (typeof o.addEventListener == "function") o.addEventListener(s, function n(i) { t.once && o.removeEventListener(s, n), e(i) });
            else throw new TypeError('The "emitter" argument must be of type EventEmitter. Received type ' + typeof o)
        }
    });
    var le = X(H());
    var d = { timeout: 1, transportClosed: 2, clientDisconnected: 3, clientClosed: 4, clientConnectToken: 5, clientRefreshToken: 6, subscriptionUnsubscribed: 7, subscriptionSubscribeToken: 8, subscriptionRefreshToken: 9, transportWriteError: 10, connectionClosed: 11 }, v = { connectCalled: 0, transportClosed: 1, noPing: 2, subscribeTimeout: 3, unsubscribeError: 4 }, O = { disconnectCalled: 0, unauthorized: 1, badProtocol: 2, messageSizeLimit: 3 }, L = { subscribeCalled: 0, transportClosed: 1 }, B = { unsubscribeCalled: 0, unauthorized: 1, clientClosed: 2 };
    var j = (t => (t.Disconnected = "disconnected", t.Connecting = "connecting", t.Connected = "connected", t))(j || {}), D = (t => (t.Unsubscribed = "unsubscribed", t.Subscribing = "subscribing", t.Subscribed = "subscribed", t))(D || {});
    function ae(o, s) { return o.lastIndexOf(s, 0) === 0 }
    function K(o) { return o == null ? !1 : typeof o == "function" }
    function ce(o, s) {
        if (globalThis.console) {
            let e = globalThis.console[o];
            K(e) && e.apply(globalThis.console, s)
        }
    }
    function Ee(o, s) { return Math.floor(Math.random() * (s - o + 1) + o) }
    function S(o, s, e) {
        o > 31 && (o = 31);
        let t = Ee(0, Math.min(e, s * Math.pow(2, o)));
        return Math.min(e, s + t)
    }
    function ue(o) { return "error" in o && o.error !== null }
    ...
    var I = class extends le.default {
        ...
        ready(e) {
            return this.state === "unsubscribed" ? Promise.reject({ code: d.subscriptionUnsubscribed, message: this.state }) : this.state === "subscribed" ? Promise.resolve() : new Promise((t, n) => {
                let i = { resolve: t, reject: n };
                e && (i.timeout = setTimeout(function () { n({ code: d.timeout, message: "timeout" }) }, e)), this._promises[this._nextPromiseId()] = i
            })
        }
        subscribe() { this._isSubscribed() || (this._resubscribeAttempts = 0, this._setSubscribing(L.subscribeCalled, "subscribe called")) }
        unsubscribe() { this._setUnsubscribed(B.unsubscribeCalled, "unsubscribe called", !0) }
        publish(e) {
            let t = this;
        ...
        _methodCall() {
            return this._isSubscribed() ? Promise.resolve() : this._isUnsubscribed() ? Promise.reject({ code: d.subscriptionUnsubscribed, message: this.state }) : new Promise((e, t) => {
                let n = setTimeout(function () { t({ code: d.timeout, message: "timeout" }) }, this._centrifuge._config.timeout);
        ...
        _usesToken() { return this._token !== null || this._getToken !== null }
        ...
        _setSubscribing(e, t) { this._isSubscribing() || (this._isSubscribed() && this._clearSubscribedState(), this._setState("subscribing") && this.emit("subscribing", { channel: this.channel, code: e, reason: t }), this._subscribe(!1, !1)) }
        _subscribe(e, t) {
                ...
                if (this._token) return this._sendSubscribe(this._token, t);
                {
                    ...
                    return this._getSubscriptionToken().then(function (i) {
                        ...
                        !n._isSubscribing() || (n.emit("error", {
                            type: "subscribeToken", channel: n.channel, error: { code: d.subscriptionSubscribeToken, message: i !== void 0 ? i.toString() : "" }
        ...
        _sendSubscribe(e, t) {
            ...
            }, a => { this._inflight = !1, this._handleSubscribeError(a.error), a.next && a.next() }), r
        }
        ...
        _resolvePromises() { for (let e in this._promises) this._promises[e].timeout && clearTimeout(this._promises[e].timeout), this._promises[e].resolve(), delete this._promises[e] }
        _rejectPromises(e) { for (let t in this._promises) this._promises[t].timeout && clearTimeout(this._promises[t].timeout), this._promises[t].reject(e), delete this._promises[t] }
        ...
        _setOptions(e) { !e || (e.since && (this._offset = e.since.offset, this._epoch = e.since.epoch, this._recover = !0), e.data && (this._data = e.data), e.minResubscribeDelay !== void 0 && (this._minResubscribeDelay = e.minResubscribeDelay), e.maxResubscribeDelay !== void 0 && (this._maxResubscribeDelay = e.maxResubscribeDelay), e.token && (this._token = e.token), e.getToken && (this._getToken = e.getToken), e.positioned === !0 && (this._positioned = !0), e.recoverable === !0 && (this._recoverable = !0), e.joinLeave === !0 && (this._joinLeave = !0)) }
        _getOffset() {
            let e = this._offset;
            return e !== null ? e : 0
        }
        ...
        _refresh() {
            ...
            this._getSubscriptionToken().then(function (t) {
                ...
                e._token = t;
                let i = {
                    sub_refresh: { channel: e.channel, token: t }
                };
                ...
                e.emit("error", {
                    type: "refreshToken", channel: e.channel, error: { code: d.subscriptionRefreshToken, message: t !== void 0 ? t.toString() : "" }
        ...
        _refreshError(e) { !this._isSubscribed() || (e.code < 100 || e.temporary === !0 ? (this.emit("error", { type: "refresh", channel: this.channel, error: e }), this._refreshTimeout = setTimeout(() => this._refresh(), this._getRefreshRetryDelay())) : this._setUnsubscribed(e.code, e.message, !0)) }
        _getRefreshRetryDelay() { return S(0, 1e4, 2e4) }
        _failUnauthorized() { this._setUnsubscribed(B.unauthorized, "unauthorized", !0) }
    };
    var U = class {
    ...
    var A = class {
        constructor(s, e) { this.endpoint = s, this.options = e, this._abortController = null, this._utf8decoder = new TextDecoder, this._protocol = "json" }
                    ...
                    start(m) {
                        function w() {
                            return b.read().then(({ done: h, value: _ }) => {
                                ...
                                try {
                                    if (s._protocol === "json") for (a += s._utf8decoder.decode(_);
                                        c < a.length;)if (a[c] === `
`) {
                                        ...
                                        for (f.set(l), f.set(_, l.length), l = f;
                                            ;) {
                                            let p = s.options.decoder.decodeReply(l);
                                            if (p.ok) {
                                                let P = l.slice(0, p.pos);
                                                n.dispatchEvent(new MessageEvent("message", { data: P })), l = l.slice(p.pos);
                                                continue
                                            }
                                            break
                                        }
                                ...
                                w()
                            }).catch(function (h) { n.dispatchEvent(new Event("error", { detail: h })), n.dispatchEvent(new Event("close")), m.close() })
                        }
                        return w()
                    }
                })
        ...
        supported() { return this.options.fetch !== null && this.options.readableStream !== null && typeof TextDecoder != "undefined" && typeof AbortController != "undefined" && typeof EventTarget != "undefined" && typeof Event != "undefined" && typeof MessageEvent != "undefined" && typeof Error != "undefined" }
        initialize(s, e, t) {
            this._protocol = s, this._abortController = new AbortController;
            let n, i;
            s === "json" ? (n = { Accept: "application/json", "Content-Type": "application/json" }, i = t) : (n = { Accept: "application/octet-stream", "Content-Type": "application/octet-stream" }, i = t);
            let r = { method: "POST", headers: n, body: i, mode: "cors", credentials: "same-origin", cache: "no-cache", signal: this._abortController.signal }, a = this._fetchEventTarget(this, this.endpoint, r);
            a.addEventListener("open", () => { e.onOpen() }), a.addEventListener("error", c => { this._abortController.abort(), e.onError(c) }), a.addEventListener("close", () => { this._abortController.abort(), e.onClose({ code: 4, reason: "connection closed" }) }), a.addEventListener("message", c => { e.onMessage(c.data) })
        }
        ...
        send(s, e, t) {
            ...
            let a = this.options.fetch, c = { method: "POST", headers: n, body: i, mode: "cors", credentials: "same-origin", cache: "no-cache" };
            a(this.options.emulationEndpoint, c)
        }
    };
    var M = class {
        constructor(s, e) { this.endpoint = s, this.options = e, this._protocol = "json", this._transport = null, this._onClose = null }
        name() { return "sse" }
        subName() { return "sse" }
        emulation() { return !0 }
        ...
        initialize(s, e, t) {
            ...
            this._transport = r;
            let a = this;
            r.onopen = function () { e.onOpen() }, r.onerror = function (c) { r.close(), e.onError(c), e.onClose({ code: 4, reason: "connection closed" }) }, r.onmessage = function (c) { e.onMessage(c.data) }, a._onClose = function () { e.onClose({ code: 4, reason: "connection closed" }) }
        }
        close() { this._transport.close(), this._onClose !== null && this._onClose() }
        send(s, e, t) {
            let n = { session: e, node: t, data: s }, i = { "Content-Type": "application/json" }, r = JSON.stringify(n), a = this.options.fetch, c = { method: "POST", headers: i, body: r, mode: "cors", credentials: "same-origin", cache: "no-cache" };
            a(this.options.emulationEndpoint, c)
        }
    };
    var N = class {
        constructor(s, e) { this.endpoint = s, this.options = e, this._transport = null, this._stream = null, this._writer = null, this._utf8decoder = new TextDecoder, this._protocol = "json" }
        ...
        initialize(s, e) {
            return C(this, null, function* () {
                ...
                this._transport = new this.options.webtransport(t.toString()), this._transport.closed.then(() => { e.onClose({ code: 4, reason: "connection closed" }) }).catch(() => { e.onClose({ code: 4, reason: "connection closed" }) });
                try { yield this._transport.ready }
                catch (r) {
                    this.close();
                    return
                }
                let i;
                try { i = yield this._transport.createBidirectionalStream() }
                catch (r) {
                    this.close();
                    return
                }
                this._stream = i, this._writer = this._stream.writable.getWriter(), n.addEventListener("close", () => { e.onClose({ code: 4, reason: "connection closed" }) }), n.addEventListener("message", r => { e.onMessage(r.data) }), this._startReading(n), e.onOpen()
            })
        }
        _startReading(s) {
            return C(this, null, function* () {
                ...
                try {
                    for (;
                        ...
                        let { done: r, value: a }
                            = yield e.read();
                        if (a.length > 0) if (this._protocol === "json") for (t += this._utf8decoder.decode(a);
                            n < t.length;)if (t[n] === `
`) {
                ...
                catch (r) { s.dispatchEvent(new Event("close")) }
            })
        }
        close() {
            return C(this, null, function* () {
                try { this._writer && (yield this._writer.close()), this._transport.close() }
                catch (s) { }
            })
        }
        send(s) {
...
`) : e = s;
                try { yield this._writer.write(e) }
                catch (t) { this.close() }
            })
        }
    };
...
`).map(e => JSON.parse(e))
    ...
    var he = X(H());
    var we = { protocol: "json", token: null, getToken: null, data: null, debug: !1, name: "js", version: "", fetch: null, readableStream: null, websocket: null, eventsource: null, sockjs: null, sockjsOptions: {}, emulationEndpoint: "/emulation", minReconnectDelay: 500, maxReconnectDelay: 2e4, timeout: 5e3, maxServerPingDelay: 1e4, networkEventTarget: null }, T = class extends he.default {
        constructor(e, t) {
            super();
        ...
        ready(e) {
            return this.state === "disconnected" ? Promise.reject({ code: d.clientDisconnected, message: "client disconnected" }) : this.state === "connected" ? Promise.resolve() : new Promise((t, n) => {
                let i = { resolve: t, reject: n };
                e && (i.timeout = setTimeout(function () { n({ code: d.timeout, message: "timeout" }) }, e)), this._promises[this._nextPromiseId()] = i
            })
        }
        ...
        disconnect() { this._disconnect(O.disconnectCalled, "disconnect called", !1) }
        send(e) {
            let t = {
                send: { data: e }
            }, n = this;
            return this._methodCall().then(function () { return n._transportSendCommands([t]) ? Promise.resolve() : Promise.reject(n._createErrorObject(d.transportWriteError, "transport write error")) })
        }
        rpc(e, t) {
            let n = {
                rpc: { method: e, data: t }
        ...
        history(e, t) {
            ...
            return this._methodCall().then(function () {
                return i._callPromise(n, function (r) {
                    let a = r.history, c = [];
                    if (a.publications) for (let l = 0;
                        l < a.publications.length;
                        l++)c.push(i._getPublicationContext(e, a.publications[l]));
        ...
        _debug(...e) { !this._debugEnabled || ce("debug", e) }
        _setFormat(e) {
        ...
        _setNetworkEvents() {
            let e = null;
            this._config.networkEventTarget !== null ? e = this._config.networkEventTarget : typeof globalThis.addEventListener != "undefined" && (e = globalThis), e && (e.addEventListener("offline", () => { this._debug("offline event triggered"), this.state === "connected" && this._transport && !this._transportClosed && (this._transportClosed = !0, this._transport.close()) }), e.addEventListener("online", () => { this._debug("online event triggered"), this.state === "connecting" && (this._clearReconnectTimeout(), this._startReconnecting()) }))
        }
        _getReconnectDelay() {
        ...
        _clearOutgoingRequests() {
            for (let e in this._callbacks) if (this._callbacks.hasOwnProperty(e)) {
                ...
                let n = t.errback;
                if (!n) continue;
                n({ error: this._createErrorObject(d.connectionClosed, "connection closed") })
            }
            this._callbacks = {}
        }
        ...
        _handleWriteError(e) {
            for (let t of e) {
                ...
                let r = i.errback;
                r({ error: this._createErrorObject(d.transportWriteError, "transport write error") })
            }
        }
        _transportSendCommands(e) {
            if (!e.length) return !0;
            if (!this._transport) return !1;
            try { this._transport.send(this._encoder.encodeCommands(e), this._session, this._node) }
            catch (t) { return this._debug("error writing commands", t), this._handleWriteError(e), !1 }
            return !0
        }
        _initializeTransport() {
            ...
            let i = null;
            this._config.fetch !== null ? i = this._config.fetch : typeof globalThis.fetch != "undefined" && (i = globalThis.fetch);
            let r = null;
            if (this._config.readableStream !== null ? r = this._config.readableStream : typeof globalThis.ReadableStream != "undefined" && (r = globalThis.ReadableStream), this._emulation) {
                ...
                for (;
                    ...
                    let _ = this._transports[this._currentTransportIndex], f = _.transport, p = _.endpoint;
                    if (f === "websocket") {
                        if (this._debug("trying websocket transport"), this._transport = new E(p, { websocket: e }), !this._transport.supported()) {
                            this._debug("websocket transport not available"), this._currentTransportIndex++, h++;
                            continue
                        }
                    }
                    else if (f === "webtransport") {
                        if (this._debug("trying webtransport transport"), this._transport = new N(p, { webtransport: globalThis.WebTransport, decoder: this._decoder, encoder: this._encoder }), !this._transport.supported()) {
                            this._debug("webtransport transport not available"), this._currentTransportIndex++, h++;
                            continue
                        }
                    }
                    else if (f === "http_stream") {
                        if (this._debug("trying http_stream transport"), this._transport = new A(p, { fetch: i, readableStream: r, emulationEndpoint: this._config.emulationEndpoint, decoder: this._decoder, encoder: this._encoder }), !this._transport.supported()) {
                            this._debug("http_stream transport not available"), this._currentTransportIndex++, h++;
                            continue
                        }
                    }
                    else if (f === "sse") {
                        if (this._debug("trying sse transport"), this._transport = new M(p, { eventsource: n, fetch: i, emulationEndpoint: this._config.emulationEndpoint }), !this._transport.supported()) {
                            this._debug("sse transport not available"), this._currentTransportIndex++, h++;
                            continue
                        }
                    }
                    else if (f === "sockjs") {
                        if (this._debug("trying sockjs"), this._transport = new U(p, { sockjs: t, sockjsOptions: this._config.sockjsOptions }), !this._transport.supported()) {
                ...
                if (this._debug("client will use websocket"), this._transport = new E(this._endpoint, { websocket: e }), !this._transport.supported()) throw new Error("WebSocket not available")
            }
            ...
            this._transport.initialize(this._config.protocol, {
                onOpen: function () { l = !0, c = a._transport.subName(), a._debug(c, "transport open"), a._transportWasOpen = !0, a._transportClosed = !1, !a._transport.emulation() && (a.startBatching(), a._sendConnect(!1), b && a._sendSubscribeCommands(!0, !1), a.stopBatching()) }, onError: function (h) { a._debug("transport level error", h) }, onClose: function (h) {
                    a._debug(a._transport.name(), "transport closed"), a._transportClosed = !0;
                    let _ = "connection closed", f = !0, p = 0;
                    if (h && "code" in h && h.code && (p = h.code), h && h.reason) try {
                        let g = JSON.parse(h.reason);
                        _ = g.reason, f = g.reconnect
                    }
                        catch (g) { _ = h.reason, (p >= 3500 && p < 4e3 || p >= 4500 && p < 5e3) && (f = !1) }
                    p < 3e3 ? (p === 1009 ? (p = O.messageSizeLimit, _ = "message size limit exceeded", f = !1) : (p = v.transportClosed, _ = "transport closed"), a._emulation && !a._transportWasOpen && (a._currentTransportIndex++, a._currentTransportIndex >= a._transports.length && (a._triedAllTransports = !0, a._currentTransportIndex = 0))) : a._transportWasOpen = !0;
                    let P = !1;
                    if (a._emulation && !a._transportWasOpen && !a._triedAllTransports && (P = !0), a._isConnecting() && !l && a.emit("error", { type: "transport", error: { code: d.transportClosed, message: "transport closed" }, transport: a._transport.name() }), a._disconnect(p, _, f), a._isConnecting()) {
                        let g = a._getReconnectDelay();
                        P && (g = 0), a._debug("reconnect after " + g + " milliseconds"), a._reconnecting = !1, a._reconnectTimeout = setTimeout(() => { a._startReconnecting() }, g)
                    }
                }, onMessage: function (h) { a._dataReceived(h) }
            }, w)
        }
        _sendConnect(e) {
        ...
        _startReconnecting() {
            if (!this._isConnecting() || this._reconnecting) return;
            ...
            this._getToken().then(function (n) {
                ...
                t.emit("error", {
                    type: "connectToken", error: { code: d.clientConnectToken, message: n !== void 0 ? n.toString() : "" }
                });
                let i = t._getReconnectDelay();
                t._debug("error on connection token refresh, reconnect after " + i + " milliseconds", n), t._reconnecting = !1, t._reconnectTimeout = setTimeout(() => { t._startReconnecting() }, i)
            })
        }
        _connectError(e) { this.state === "connecting" && (e.code === 109 && (this._refreshRequired = !0), e.code < 100 || e.temporary === !0 || e.code === 109 ? (this.emit("error", { type: "connect", error: e }), this._transport && !this._transportClosed && (this._transportClosed = !0, this._transport.close())) : this._disconnect(e.code, e.message, !1)) }
        ...
        _methodCall() {
            return this._isConnected() ? Promise.resolve() : new Promise((e, t) => {
                let n = setTimeout(function () { t({ code: d.timeout, message: "timeout" }) }, this._config.timeout);
                this._promises[this._nextPromiseId()] = { timeout: n, resolve: e, reject: t }
            })
        }
        _callPromise(e, t) { return new Promise((n, i) => { this._call(e, !1).then(r => { n(t(r.reply)), r.next && r.next() }, r => { i(r.error), r.next && r.next() }) }) }
        _dataReceived(e) {
        ...
        _call(e, t) { return new Promise((n, i) => { e.id = this._nextCommandId(), this._registerCall(e.id, n, i), t || this._addCommand(e) }) }
        _startConnecting() { this._debug("start connecting"), this._setState("connecting") && this.emit("connecting", { code: v.connectCalled, reason: "connect called" }), this._client = null, this._startReconnecting() }
        _disconnect(e, t, n) {
            if (this._isDisconnected()) return;
            let i = this.state, r = { code: e, reason: t }, a = !1;
            n ? a = this._setState("connecting") : (a = this._setState("disconnected"), this._rejectPromises({ code: d.clientDisconnected, message: "disconnected" })), this._clearOutgoingRequests(), i === "connecting" && this._clearReconnectTimeout(), i === "connected" && this._clearConnectedState(), a && (this._isConnecting() ? this.emit("connecting", r) : this.emit("disconnected", r)), this._transport && !this._transportClosed && (this._transportClosed = !0, this._transport.close())
        }
        _failUnauthorized() { this._disconnect(O.unauthorized, "unauthorized", !1) }
        _getToken() {
        ...
        _refresh() {
            ...
            this._getToken().then(function (n) {
                ...
                t.emit("error", {
                    type: "refreshToken", error: { code: d.clientRefreshToken, message: n !== void 0 ? n.toString() : "" }
                }), t._refreshTimeout = setTimeout(() => t._refresh(), t._getRefreshRetryDelay())
            })
        }
        _refreshError(e) { e.code < 100 || e.temporary === !0 ? (this.emit("error", { type: "refresh", error: e }), this._refreshTimeout = setTimeout(() => this._refresh(), this._getRefreshRetryDelay())) : this._disconnect(e.code, e.message, !1) }
        ...
        _unsubscribe(e) {
            ...
            let n = {
                unsubscribe: { channel: e.channel }
            }, i = this;
            this._call(n, !1).then(r => { r.next && r.next() }, r => { r.next && r.next(), i._disconnect(v.unsubscribeError, "unsubscribe error", !0) })
        }
        _getSub(e) {
            let t = this._subs[e];
            return t || null
        ...
        _connectResponse(e) {
            ...
            this._client = e.client, this._setState("connected"), this._setNetworkEvents(), this._refreshTimeout && clearTimeout(this._refreshTimeout), e.expires && (this._refreshTimeout = setTimeout(() => this._refresh(), x(e.ttl))), this._session = e.session, this._node = e.node, this.startBatching(), this._sendSubscribeCommands(!1, !1), this.stopBatching();
        ...
        _waitServerPing() { this._config.maxServerPingDelay !== 0 && (!this._isConnected() || (this._clearServerPingTimeout(), this._serverPingTimeout = setTimeout(() => { !this._isConnected() || this._disconnect(v.noPing, "no ping", !0) }, this._serverPing + this._config.maxServerPingDelay))) }
        _getSubscribeContext(e, t) {
            ...
            let r = 0;
            return "offset" in t && (r = t.offset), (n.positioned || n.recoverable) && (n.streamPosition = { offset: r, epoch: i }), t.data && (n.data = t.data), n
        }
        _handleReply(e, t) {
            let n = e.id;
        ...
        _registerCall(e, t, n) { this._callbacks[e] = { callback: t, errback: n, timeout: null }, this._callbacks[e].timeout = setTimeout(() => { delete this._callbacks[e], K(n) && n({ error: this._createErrorObject(d.timeout, "timeout") }) }, this._config.timeout) }
        _addCommand(e) { this._batching ? this._commands.push(e) : this._transportSendCommands([e]) }
        _nextPromiseId() { return ++this._promiseId }
        _resolvePromises() { for (let e in this._promises) this._promises[e].timeout && clearTimeout(this._promises[e].timeout), this._promises[e].resolve(), delete this._promises[e] }
        _rejectPromises(e) { for (let t in this._promises) this._promises[t].timeout && clearTimeout(this._promises[t].timeout), this._promises[t].reject(e), delete this._promises[t] }
    };
    T.SubscriptionState = D;
    T.State = j;
    window.Centrifuge = T;
})();
