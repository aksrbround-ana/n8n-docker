        ...
        <div class="grid grid-cols-3 gap-6">
            <div class="col-span-2 space-y-6">
                ...
                <div class="rounded-lg border bg-card text-card-foreground shadow-sm">
                    ...
                    <div class="p-6 pt-0">
                        <div class="space-y-2">
                            <a class="flex items-center justify-between p-3 rounded-lg border hover:bg-secondary/50 transition-colors" href="/documents/D-003">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p class="text-sm font-medium">Balkan_Payroll_Oct2024.xlsx</p>
