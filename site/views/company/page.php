...
<div class="p-6">
    <div class="space-y-6">
        ...
        <div id="company-filter-box" class="space-y-4">
            ...
            <div id="company-filters-row" class="hidden flex items-center gap-3 p-4 bg-secondary/50 rounded-lg animate-fade-in">
                ...
                <button id="company-reset-filters-button" class="inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 hover:bg-accent hover:text-accent-foreground h-9 rounded-md px-3 ml-auto">
                    <?= SvgService::svg('x') ?>
